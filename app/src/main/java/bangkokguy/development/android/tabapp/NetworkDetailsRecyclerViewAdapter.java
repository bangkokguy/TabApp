 ...
 */
public class NetworkDetailsRecyclerViewAdapter extends
        RecyclerView.Adapter<NetworkDetailsRecyclerViewAdapter.ViewHolder> {

    private final List<ConfigItem> mValues;
    private final OnListFragmentInteractionListener<ConfigItem> mListener;

    NetworkDetailsRecyclerViewAdapter(
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.network_details_fragment_item, parent, false);
